...
from game.views import PlaceHolder, Style, MenuRender, new_surface
...
class MainMenuDisplay(Display):
    ...
    - error_list: MenuRender
    - parallax_1: float
    - parallax_2: float
    - title: pg.Surface
    - scaled_title: tuple[pg.Surface, pg.Rect]
    ...
    def __init__(self, control: Control) -> None:
        ...
        self.title: pg.Surface = pg.image.load(
            "game/assets/menues/title.png").convert_alpha()
        self.scaled_title: tuple[pg.Surface, pg.Rect]
        self.credits: pg.Surface = pg.image.load(
            "game/assets/menues/tomb.png").convert_alpha()
        self.scaled_credits: tuple[pg.Surface, pg.Rect]
    ...
    def startup(self, menu: Menu, error_list: Menu) -> None:
        ...
        self.scaled_credits = (
            pg.transform.scale(
                self.credits, (screen_w * 0.13, screen_h * 0.27)),
            pg.Rect(screen_w * 0.83, screen_h * 0.74, 0, 0))
    ...
    def draw(self) -> None:
        ...
        self.control.interface.blits([
            ...
            self.scaled_title, self.scaled_credits])
