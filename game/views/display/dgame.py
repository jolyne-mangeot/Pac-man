...
class GameDisplay(Display):
    ...
    def load_level_assets(self) -> None:
        ...
        level_ui_sheet: SpriteSheet = SpriteSheet(
            "game/assets/level/level-interface.png")
        self.interface = {
    ...
    def load_characters_sprites(self) -> None:
        ...
        normal_sht: SpriteSheet = SpriteSheet(
            "game/assets/level/skeletons_normal_sprites.png")
        super_sht: SpriteSheet = SpriteSheet(
            "game/assets/level/skeletons_super_sprites.png")
        pacman_sht: SpriteSheet = SpriteSheet(
            "game/assets/level/character_sprites.png")
    ...
    def load_theme_sprites(self, theme: str) -> None:
        ...
        backgrounds: dict[str, pg.Surface] = {
            "background": pg.image.load(
                "game/assets/level/" + theme + "_background.png"),
            "middleground": pg.image.load(
                "game/assets/level/" + theme + "_middleground.png"),
            "foreground": pg.image.load(
                "game/assets/level/" + theme + "_foreground.png")}

        sheet: SpriteSheet = SpriteSheet(
            "game/assets/level/" + theme + "_tiles_sheet.png")
