...
from game.views import MenuRender
from game.models import Languages
...
class InstructionsMenuDisplay(Display):
    ...
    - instructions: dict[str, pg.Surface]
    - scaled_instructions: tuple[pg.Surface, pg.Rect]
    ...
    def load_instructions(self) -> None:
        self.instructions = {
            lang.value: pg.image.load(
                "game/assets/menues/instructions-" + lang.value + ".png"
